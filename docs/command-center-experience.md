...
- **Meta Ads** — daily spend, leads, cost per lead.
- **Team Pulse** — overdue count + who's behind (accountability radar; see below).
- **Today's Schedule · Week Ahead · Weather (Cleveland).**

Personal (the Personal Council, with the wellbeing guardrail):
- **Health & performance** — pulls **Apple Health** and **Whoop**
  (recovery/HRV/sleep/strain/rest HR); shows **supplement schedule**, **peptide
  protocol**, and **diet/nutrition** as daily checklists and trends. Tracks,
  displays, and reminds — it does **not** dose, prescribe, or give medical advice,
  and routes anything clinical to Lindsey's real doctor/provider.
- **Calendar protection** — training + recovery + family blocks defended.
- **Wellbeing check-in** — support only; routes to real professionals.

Data sources for the health/performance module: Apple Health, Whoop, and
Lindsey's own logged protocols (supplements, peptides, diet). Other useful signals
to surface as the module grows: training load vs. recovery trend, sleep debt
across a travel week, hydration/electrolytes, and "your body is telling you to
...
validated in shadow mode. Build it once, build it durable — Lindsey does not want
